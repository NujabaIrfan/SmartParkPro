    ...
    <section class="parking-slots">
        <div class="box-containers-parkingslots">
            <?php
                ...
                $sql = "SELECT slot_number, is_available FROM basement_parking_space ORDER BY CAST(SUBSTRING(slot_number, 3) AS UNSIGNED)";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($isParkingAvailable) {
                            $imageSrc = "./images/parking.png";
                        } else {
                            $imageSrc = "./images/noparking.png";
                        }
