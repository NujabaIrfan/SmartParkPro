  ...
  <section class="header">
    ...
    <section class = "contact-section">
      <div class = "contact-bg">
        ...
        <p class = "text1">Experience the epitome of convenience with Smart Pro Automated Parking System. Our cutting-edge technology streamlines the parking process, ensuring efficiency and ease for both drivers and operators. Say goodbye to the hassle of traditional parking systems and embrace the future of parking solutions. For inquiries, partnerships, or any assistance, don't hesitate to contact us. We're here to revolutionize your parking experience.</p>
      </div>
      ...
      <div class = "contact-body">
        <div class = "contact-info">
          <div>
            ...
            <span class = "text">+94 78 456 4567</span>
          </div>
          <div>
            <span><i class = "fas fa-envelope-open"></i></span>
            <span class="details">E-mail</span>
            <span class = "text">samrtpro@gmail.com</span>
          </div>
          <div>
            <span><i class = "fas fa-map-marker-alt"></i></span>
            <span class="details">Address</span>
            <span class = "text">296 Parking Street, Colombo, Sri Lanka</span>
          </div>
          <div>
            <span><i class = "fas fa-clock"></i></span>
            <span class="details">Opening Hours</span>
            <span class = "text">Monday - Saturday (9:00 AM to 9:00 PM)</span>
          </div>
        </div>

      <div class="map" style="width: 100%"><iframe width="100%" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=450&amp;hl=en&amp;q=colombo+(My%20Business%20Name)&amp;t=&amp;z=11&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps trackers</a></iframe></div>
      <center>

        <a class="alink" href="help&support.php">Help & Support</a>

        <a class="alink" href="feedback.php">Feedback</a>
<!-- 
        <a class="alink" href="home.php">Home</a> -->
